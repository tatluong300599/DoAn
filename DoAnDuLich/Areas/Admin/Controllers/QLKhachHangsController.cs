...
namespace DoAnDuLich.Areas.Admin.Controllers
{
    public class QLKhachHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKhachHang,MatKhau,HoTen,SoDienThoai,Email,DiaChi,TrangThai")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKhachHang,MatKhau,HoTen,SoDienThoai,Email,DiaChi,TrangThai")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
